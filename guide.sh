...
show_supabase() {
    ...
    echo -e "📖 Full walkthrough: ${BLUE}docs/production-features.md${NC}"
    step_footer
}
...
MCPEOF
    ...
    echo -e "${BOLD}Verify your setup — paste this to your AI:\n"
    ...
    echo -e "📖 ${BLUE}docs/mcp-setup.md${NC}"
    step_footer
}
...
show_security() {
    ...
    if [ "$sec_sel" -eq 1 ]; then
        ...
        echo -e "📖 ${BLUE}docs/production-features.md#email-authentication-gmail-smtp${NC}"
        step_footer; return
    fi
    ...
    echo -e "📖 ${BLUE}docs/production-features.md#security-notifications${NC}"
    step_footer
}
...
show_deploy() {
    ...
    echo -e "📖 Full Production Guide: ${BLUE}docs/production-features.md#vercel-deployment${NC}"
    step_footer
}
...
show_ui() {
    ...
    echo -e "📖 ${BLUE}docs/ui-system.md${NC}"
    step_footer
}
